...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/repo.EntityBulkEditListResult"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "repo.EntityBulkEditListResult": {
            "type": "object",
            "properties": {
                "fieldDefinitions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repo.EntityFieldDefinition"
                    }
                },
                "items": {
                    "type": "array",
